...
public class AxisSlider extends BorderPane {
    ...
    private final SuppliedProperty<ImageDisplay, Number> position;

    SuppliedProperty<ImageDisplay, Number> minProperty = new SuppliedProperty<ImageDisplay, Number>()
            .setGetter(this::getMinSlider);

    SuppliedProperty<ImageDisplay, Number> maxProperty = new SuppliedProperty<ImageDisplay, Number>()
    ...
    public AxisSlider(ImageDisplay display, int id) {
        ...
        position = new SuppliedProperty<ImageDisplay, Number>()
    ...
    private class ViewUpdate implements Runnable {
        ...
        public ViewUpdate(ImageDisplay view) {
            this.display = view;
        }
