...
import ijfx.ui.correction.plugins.CorrectionUiPlugin;
...
import ijfx.ui.correction.plugins.CorrectionUiPluginWrapper;
...
public class CorrectionSelector extends BorderPane implements Activity {
    ...
    public void applySaveParameter(BatchItemBuilder builder) {
    ...
    @FXML
    public void back() {
        activityService.open(FolderSelection.class);
    }
