...
import ijfx.segmentation.core.ThresholdSegmentation;
 ...
 */
@Plugin(type = InteractiveSegmentationUI.class, label = "Fixed / Automatic threshold", priority = 0.1)
public class ThresholdSegmentationUI extends BorderPane implements InteractiveSegmentationUI<ThresholdSegmentation> {
    ...
    public ThresholdSegmentationUI() {
        ...
        try {
            ...
            Logger.getLogger(ThresholdSegmentationUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public Class<? extends InteractiveSegmentation> getSupportedType() {
        ...
        return ThresholdSegmentation.class;
        
    }

    @Override
    public ThresholdSegmentation getCurrentSegmentation() {
        return segmentationProperty.getValue();
    }
