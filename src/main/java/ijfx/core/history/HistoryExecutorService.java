...
import ijfx.core.workflow.WorkflowEnd;
import ijfx.core.workflow.WorkflowEndedEvent;
import ijfx.core.workflow.WorkflowStartEvent;
...
public class HistoryExecutorService extends AbstractService implements ImageJService {
    ...
    public WorkflowStep duplicate(WorkflowStep step) {
        ...
        DefaultWorkflowStep duplicatedStep = new DefaultWorkflowStep(getContext(),step.getModule().getInfo().getDelegateClassName());
