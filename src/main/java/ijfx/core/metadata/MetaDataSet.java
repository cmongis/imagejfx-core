...
public class MetaDataSet extends HashMap<String, MetaData> {
    ...
    public MetaDataSet mergeTo(MetaDataSet set) {
        set.merge(this);
        return this;
    }
    ...
    public boolean isSameType(MetaDataSet set) {
        return isType(set.getType());
    }
    public boolean isType(MetaDataSetType metaDataSetType) {
        return type.equals(metaDataSetType);
    }
