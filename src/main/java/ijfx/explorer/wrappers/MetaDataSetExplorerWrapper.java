 ...
 */
package ijfx.explorer.wrappers;
...
public class MetaDataSetExplorerWrapper extends AbstractExplorable implements Explorable{
    ...
    public MetaDataSetExplorerWrapper(MetaData... metaDatas) {
        this(new MetaDataSet());
        Stream
                .of(metaDatas)
                .forEach(getMetaDataSet()::put);
    ...
    public String getTitle() {
        String value =  getMetaDataSet().get(MetaData.FILE_NAME).getStringValue();
